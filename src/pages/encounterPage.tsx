...
// Helper: extract patient ID from the reference string "Patient/1000"
function getPatientIdFromReference(reference: string): string {
              ...
              {filtered.map((enc) => (
                <tr key={enc.id}>
                  <td style={{ fontFamily: "monospace", fontSize: "12px" }}>
                    {enc.subject.display ??
                      getPatientIdFromReference(enc.subject.reference)}
                  </td>
